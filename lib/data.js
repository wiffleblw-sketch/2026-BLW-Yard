...
export const TEAM_PRESETS = [
  { name: 'Wolves',   abbr: 'WLV', primary: '#EAB308', logoKey: 'wolves'   },
  { name: 'Panthers', abbr: 'PAN', primary: '#EA580C', logoKey: 'panthers' },
];

// Seed games + plays + pitching from today's three games
